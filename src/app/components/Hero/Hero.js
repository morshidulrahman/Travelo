        ...
        <SwiperSlide>
          <div className="w-full h-[350px] lg:h-[500px]   banner_image3 ">
            <div className="z-50 lg:p-36 md:24 p-10">
              <h2 className="capitalize text-5xl  md:text-6xl font-extrabold text-white md:w-[40%] w-[90%]">
                Explore the <span className="text-[#F26f55]"> world</span> now
              </h2>
              <p className="w-[90%] md:w-[60%] text-white py-4">
                Our team of experienced travel experts will help you plan your
                trip from start to finish, ensuring your dream vacation becomes
                a reality. Don't wait any longer
              </p>
